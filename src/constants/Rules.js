  ...
  return {
    ...
    rules: {
      ...
      transform: {
        ...
        translateX: (state: StyleType, value: StyleValueType) => gradualConstrain(value, state.speed.translateX, -state.env.radius/3, state.env.radius/3, 0.1),
        translateY: (state: StyleType, value: StyleValueType) => gradualConstrain(value, state.speed.translateY, -state.env.radius/3, state.env.radius/3, 0.1),
        translateZ: (state: StyleType, value: StyleValueType) => gradualConstrain(value, state.speed.translateZ, -state.env.radius/3, state.env.radius/3, 0.1),
